...
def read_result_data(filename, print_mode=True):
    ...
    return time_result_list, frame_list, id_list, x_list, y_list, vx_list, vy_list, x0_list, y0_list, z0_list, l_list, w_list, h_list, phi_list

def compute_error(time_gps_list, time_result_list, xg_list, yg_list, vxg_list, vyg_list, length, width, x0_list, y0_list, vx_list, vy_list, l_list, w_list):
    # 功能：计算误差
    
    ex_list, ey_list, evx_list, evy_list, el_list, ew_list = [], [], [], [], [], []
    ...
    return ex_list, ey_list, evx_list, evy_list, el_list, ew_list
    
def crop_data(dis_list, ex_list, ey_list, evx_list, evy_list, el_list, ew_list, min_dis=0, max_dis=50):
    # 功能：截取有效数据
    ...
    dis_list, ex_list, ey_list, evx_list, evy_list, el_list, ew_list = [], [], [], [], [], [], []
    ...
    return dis_list, ex_list, ey_list, evx_list, evy_list, el_list, ew_list
    
def plot_data(axes, time_gps_list, time_result_list, xg_list, yg_list, vxg_list, vyg_list, length, width, x0_list, y0_list, vx_list, vy_list, l_list, w_list, color='red'):
    # 功能：绘制数据
    ...
    # 绘制l
    axes[2, 0].plot(time_result_list, [LENGTH] * len(time_result_list), color='black', linestyle='-', linewidth=1, label='Truth')
    ...
    # 绘制w
    axes[2, 1].plot(time_result_list, [WIDTH] * len(time_result_list), color='black', linestyle='-', linewidth=1, label='Truth')
...
def plot_error(axes, dis_list, ex_list, ey_list, evx_list, evy_list, el_list, ew_list, color='red', label='20km/h', xlabel='Distance / (m)', xticks=[], yticks_xy=[], yticks_vxvy=[], yticks_lw=[]):
    # 功能：绘制误差曲线
...
if __name__ == '__main__':
    ...
    time_gps_list_15, xg_list_15, yg_list_15, vxg_list_15, vyg_list_15, phig_list_15 = read_gps_data(filename, XG1, YG1, XG2, YG2, print_mode=True)
    filename = '/home/lishangjie/detection-and-tracking_doc/result/2021-04-07-experiment/single-target/GPS_data/line1_40.txt'
    time_gps_list_40, xg_list_40, yg_list_40, vxg_list_40, vyg_list_40, phig_list_40 = read_gps_data(filename, XG1, YG1, XG2, YG2, print_mode=True)
    ...
    time_result_list_15, frame_result_list_15, id_list_15, x_list_15, y_list_15, vx_list_15, vy_list_15, x0_list_15, y0_list_15, z0_list_15, l_list_15, w_list_15, h_list_15, phi_list_15 = \
    ...
    time_result_list_40, frame_result_list_40, id_list_40, x_list_40, y_list_40, vx_list_40, vy_list_40, x0_list_40, y0_list_40, z0_list_40, l_list_40, w_list_40, h_list_40, phi_list_40 = \
        read_result_data(filename, print_mode=True)
    ...
    # 计算误差
    ex_list_15, ey_list_15, evx_list_15, evy_list_15, el_list_15, ew_list_15 = compute_error(
        time_gps_list_15, time_result_list_15, xg_list_15, yg_list_15, vxg_list_15, vyg_list_15, LENGTH, WIDTH, x0_list_15, y0_list_15, vx_list_15, vy_list_15, l_list_15, w_list_15)
    ex_list_40, ey_list_40, evx_list_40, evy_list_40, el_list_40, ew_list_40 = compute_error(
        time_gps_list_40, time_result_list_40, xg_list_40, yg_list_40, vxg_list_40, vyg_list_40, LENGTH, WIDTH, x0_list_40, y0_list_40, vx_list_40, vy_list_40, l_list_40, w_list_40)
    
    # 绘制15km/h工况的GPS数据和结果数据
    fig, axes = plt.subplots(3, 2, figsize=(4.5, 6))
    fig.canvas.set_window_title('X direction 15km/h')
    plt.subplots_adjust(left=0.125, right=0.875, bottom=0.125, top=0.875, wspace=0.4, hspace=0.8)
    axes = plot_data(
        axes, time_gps_list_15, time_result_list_15, xg_list_15, yg_list_15, vxg_list_15, vyg_list_15, LENGTH, WIDTH, x0_list_15, y0_list_15, vx_list_15, vy_list_15, l_list_15, w_list_15, color='red')
    ...
    plt.subplots_adjust(left=0.125, right=0.875, bottom=0.125, top=0.875, wspace=0.4, hspace=0.8)
    axes = plot_data(
        axes, time_gps_list_40, time_result_list_40, xg_list_40, yg_list_40, vxg_list_40, vyg_list_40, LENGTH, WIDTH, x0_list_40, y0_list_40, vx_list_40, vy_list_40, l_list_40, w_list_40, color='blue')
    fig.savefig('X direction original data in 40.png', dpi=100)
    
    # 截取有效数据
    x0_list_15, ex_list_15, ey_list_15, evx_list_15, evy_list_15, el_list_15, ew_list_15 = crop_data(
        x0_list_15, ex_list_15, ey_list_15, evx_list_15, evy_list_15, el_list_15, ew_list_15, min_dis=7, max_dis=43)
    x0_list_40, ex_list_40, ey_list_40, evx_list_40, evy_list_40, el_list_40, ew_list_40 = crop_data(
        x0_list_40, ex_list_40, ey_list_40, evx_list_40, evy_list_40, el_list_40, ew_list_40, min_dis=7, max_dis=43)
    ...
    plt.subplots_adjust(left=0.125, right=0.875, bottom=0.125, top=0.875, wspace=0.4, hspace=0.8)
    axes = plot_error(
        axes, x0_list_15, ex_list_15, ey_list_15, evx_list_15, evy_list_15, el_list_15, ew_list_15, color='red', label='20km/h', xlabel='X coordinate',
         xticks=[10, 20, 30, 40], yticks_xy=[0, 2], yticks_vxvy=[0, 2], yticks_lw=[0, 4])
    axes = plot_error(
        axes, x0_list_40, ex_list_40, ey_list_40, evx_list_40, evy_list_40, el_list_40, ew_list_40, color='blue', label='40km/h', xlabel='X coordinate',
         xticks=[10, 20, 30, 40], yticks_xy=[0, 2], yticks_vxvy=[0, 2], yticks_lw=[0, 4])
    ...
    # 截取有效数据
    y0_list_15, ex_list_15, ey_list_15, evx_list_15, evy_list_15, el_list_15, ew_list_15 = crop_data(
        y0_list_15, ex_list_15, ey_list_15, evx_list_15, evy_list_15, el_list_15, ew_list_15, min_dis=-8, max_dis=10)
    y0_list_40, ex_list_40, ey_list_40, evx_list_40, evy_list_40, el_list_40, ew_list_40 = crop_data(
        y0_list_40, ex_list_40, ey_list_40, evx_list_40, evy_list_40, el_list_40, ew_list_40, min_dis=-8, max_dis=10)
    ...
    plt.subplots_adjust(left=0.125, right=0.875, bottom=0.125, top=0.875, wspace=0.4, hspace=0.8)
    axes = plot_error(
        axes, y0_list_15, ex_list_15, ey_list_15, evx_list_15, evy_list_15, el_list_15, ew_list_15, color='red', label='20km/h', xlabel='Y coordinate',
         xticks=[-10, 0, 10], yticks_xy=[0, 1], yticks_vxvy=[0, 2], yticks_lw=[0, 2])
    axes = plot_error(
        axes, y0_list_40, ex_list_40, ey_list_40, evx_list_40, evy_list_40, el_list_40, ew_list_40, color='blue', label='40km/h', xlabel='Y coordinate',
         xticks=[-10, 0, 10], yticks_xy=[0, 1], yticks_vxvy=[0, 2], yticks_lw=[0, 2])
